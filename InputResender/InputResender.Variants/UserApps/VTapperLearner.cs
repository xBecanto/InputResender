...
namespace InputResender.Variants.UserApps;
public class VTapperLearner : DCommand_IRCore {
	...
	public VTapperLearner ( DInputResenderCore owner, string parentDsc = null )
	...
	public override ComponentBase.StateInfo Info => throw new System.NotImplementedException ();
}