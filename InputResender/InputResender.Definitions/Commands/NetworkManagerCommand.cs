...
using MdxLibs.Services.NetClientService.InMemNet;

namespace InputResender.Definitions.Commands;
public class NetworkManagerCommand : DCommand_CoreBase {
	...
	public NetworkManagerCommand ( CoreBase owner, string parentDsc = null )
...
public class ListHostsNetworkCommand : DCommand_CoreBase {
...
public class NetworkConnsManagerCommand : DCommand_CoreBase {
...
public class NetworkCallbacks : DCommand_CoreBase {
...
public class EndPointInfoCommand : DCommand_CoreBase {
