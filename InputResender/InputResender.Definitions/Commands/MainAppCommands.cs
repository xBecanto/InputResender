...
public class PasswordManagerCommand : DCommand_IRCore {
	...
	public PasswordManagerCommand ( DInputResenderCore owner, DCommand_IRCore parent = null )
...
public class TargetManagerCommand : DCommand_IRCore {
...
public class HookCallbackManagerCommand : DCommand_IRCore {
	...
	public HookCallbackManagerCommand ( DInputResenderCore owner, DCommand_IRCore parent = null )
		: base ( owner, parent?.CallName, CommandNames, InterCommands ) { }
